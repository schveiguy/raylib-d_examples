...
//import raylib.rlgl;           // Required for: Vertex definition
...
void main()
{
    ...
    auto file = (thisExePath().dirName ~ "/../resources/cat.png").buildNormalizedPath.toStringz;
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            DrawText("textured polygon", 20, 20, 20, Colors.DARKGRAY);

            DrawTexturePoly(texture, Vector2( GetScreenWidth()/2.0f, GetScreenHeight()/2.0f ),
                            &positions[0], &texcoords[0], MAX_POINTS, Colors.WHITE);
