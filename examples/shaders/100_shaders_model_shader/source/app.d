...
void main()
{
    ...
    auto file1 = (thisExePath().dirName ~ "/../resources/models/watermill.obj").buildNormalizedPath.toStringz;
    Model model = LoadModel(file1);                   // Load OBJ model

    auto file2 = (thisExePath().dirName ~ "/../resources/models/watermill_diffuse.png").buildNormalizedPath.toStringz;
    ...
    while (!WindowShouldClose())        // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            BeginMode3D(camera);
                ...
                DrawModel(model, position, 0.2f, Colors.WHITE);   // Draw 3d model with texture

                DrawGrid(10, 1.0f);     // Draw a grid

            EndMode3D();

            DrawText("(c) Watermill 3D model by Alberto Cano", screenWidth - 210, screenHeight - 20, 10, Colors.GRAY);
